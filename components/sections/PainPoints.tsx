          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6 md:p-8">
            ...
            <div className="mt-5 pt-4 border-t border-gray-100">
              <p className="text-xs text-gray-400 italic">
                Result: you mispronounce the bride&apos;s name. You skip a
                detail they specifically asked you to mention.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-lg border-l-4 border-l-emerald-500 border border-gray-200 bg-white p-6 md:p-8">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Event mode ready. You just show up and perform.",
              ].map((item, i) => (
                <li key={i} className="flex items-start gap-2.5">
                  <svg
                    width="16"
            ...
            <div className="mt-5 pt-4 border-t border-gray-100">
              <p className="text-xs text-emerald-600 font-medium">
                Result: perfect pronunciation. Every detail nailed. Confident
                delivery.
              </p>
            </div>
          </div>
